...
export class HomeService {
  ...
  getAvailableProducts(currentUserId) {
    ...
    return this.httpClient.get('https://exchangeapp.tk:3000/api/queries/availableProducts',
  ...
  addToCart(productId, buyerId) {
    ...
    return this.httpClient.post('https://exchangeapp.tk:3001/api/MoveProToCart',
  ...
  //   return this.httpClient.post('https://exchangeapp.tk:3000/api/Trade',
  //     transactionDetails, {withCredentials: true}).toPromise();
  // }
}
